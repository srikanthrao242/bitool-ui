...
public class BarChartGUI extends Charts{	
    ...
    public BarChartGUI(String ds_Name) {
		super(ds_Name);
		// TODO Auto-generated constructor stub
	}
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void createBarChartGUI(String category, String measure, String[] colNames,JavaRDD<Row> tableMap){
